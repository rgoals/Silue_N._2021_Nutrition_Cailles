...
dg_out %>% select(regime, matiere, gmq, is.outlier, is.extreme)
```
...
Pour comparer les effets des regimes deux à deux. 
...
# n'afficher seulement que les paires ayant des effets significativement différents.
```
